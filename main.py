...
app = FastAPI(
    ...
    description="국가법령정보센터 DRF API 기반 실시간 조문·항·호 조회 + 가지조문 안내 자동화",
    version="7.3.0"
)
...
# 개선: 조/가지/항/호/가지조문여부 모두 추출
def parse_article_input(article_no_raw):
    """
    '제14조의2 제1항 제4호' → (14, 2, 1, 4, True)
    '제14조의2 제1항' → (14, 2, 1, None, True)
    '제14조 제3항' → (14, None, 3, None, False)
    '제14조 제3항 제2호' → (14, None, 3, 2, False)
    '제14조' → (14, None, None, None, False)
    기타 → (None, None, None, None, False)
    """
